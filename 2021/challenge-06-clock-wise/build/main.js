...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{displayText: 'Initial Text', userInput: ''},
...
var $author$project$ClockParser$hours = function (timeString) {
	return A2(
			...
			if (!digitList.b) {
				...
				if (!n) {
					...
					var $temp$n = n - 1,
						$temp$digitList = xs;
					n = $temp$n;
					digitList = $temp$digitList;
					continue wordFromList;
				}
			}
		}
	});
var $author$project$ClockParser$digitToWord = function (n) {
	return A2($author$project$ClockParser$wordFromList, n, $author$project$ClockParser$digits);
};
var $author$project$ClockParser$teens = _List_fromArray(
...
var $author$project$ClockParser$intToMinuteString = function (n) {
	...
	switch (_v0) {
		...
		case 2:
			return A2($author$project$ClockParser$tensToWord, 2, n % 10);
		case 3:
			return A2($author$project$ClockParser$tensToWord, 3, n % 10);
		case 4:
			return A2($author$project$ClockParser$tensToWord, 4, n % 10);
		case 5:
			return A2($author$project$ClockParser$tensToWord, 5, n % 10);
		default:
			return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$ClockParser$minutes = function (timeString) {
	return A2(
		$elm$core$Maybe$andThen,
		$elm$core$String$toInt,
		A2(
			...
			case 'UpdateDisplay':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							displayText: $author$project$ClockParser$timeStringToWordString(model.userInput)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Main$speak(model.displayText));
		}
	});
var $author$project$Main$Speak = {$: 'Speak'};
var $author$project$Main$UpdateDisplay = {$: 'UpdateDisplay'};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$UpdateDisplay)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$Speak)
							]),
						_List_fromArray(
							[
